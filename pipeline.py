...
.panel {{
  border-top: 1px solid rgba(255,255,255,0.12); overflow-y: auto; padding: 8px 8px 56px 8px; background: linear-gradient(180deg,rgba(255,255,255,0.04) 0%,rgba(0,0,0,0.05) 100%),#2d4a68;
  flex: 1;
}}
